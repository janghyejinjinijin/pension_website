...
<body>
	...
	<% 
		String s[]={"JAVA방", "Python방", "CSS방","Oracle방"};
		Connection con = null;
		Statement stmt = null;
		...
		int row = rs.getRow();
		String rooms[]={"JAVA방", "Python방", "CSS방","Oracle방"};
		String roomname="";
		String out_opt="";
	...
	<form name="regform" method="post" action="register_ok.jsp" onsubmit="return regChk()">
		...
		<td>핸드폰번호 : <input type="text" name="name" maxlength="20"value=""><br></td>
